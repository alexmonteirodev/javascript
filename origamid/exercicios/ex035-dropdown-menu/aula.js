...
//-------------------------------------------------------------------------------------------------------
    ...
    //foi feito em css a animação do dropdown e toda a estilização e com mouse funciona tudo. O problema é para mobile que fica bugado então em js, foi feito de uma forma para que quando a pessoa clique o dropdown apareca e quando clique fora ele suma para ficar bom para os dois, desktop e mobile. (pasta - outside-click)
//-------------------------------------------------------------------------------------------------------
